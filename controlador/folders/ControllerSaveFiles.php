...
if (!empty($_SESSION['S_IDUSUARIO'])) {
    ...
    $alumno_ver = htmlspecialchars($_POST['alumno_ver'], ENT_QUOTES, 'UTF-8');
    ...
    if (isset($_FILES['files'])) {
        ...
        for ($i = 0; $i < $log; $i++) {
            ...
            if (move_uploaded_file($rutaTempArchivo, $rutaDestino)) {
                $consulta = $file->Registra_Files_Grado_Foders($user, $alumno_ver, $nombreArchivo, $extension, $fecha, $idfolder);
            } else {
