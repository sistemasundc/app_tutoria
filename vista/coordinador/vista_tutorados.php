        ...
        <div class="box-header with-border">
            ...
            <!-- BOTÓN DE REPORTE -->
                <div class="text-right" style="margin-top:10px">
                    <button class="btn btn-primary" id="btnGenerarLista" onclick="abrirListaTutores()">
                        <i class="fa fa-print"></i><strong> GENERAR LISTA</strong>
                    </button>
                </div>
            </div>
            <!-- /.box-body -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <select id="sdocente" name="sdocente" class="js-example-basic-single" style="width:100%;">
