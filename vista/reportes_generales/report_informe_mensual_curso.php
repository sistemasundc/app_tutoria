...
<body>
<div class="container">
    <h3>CUMPLIMIENTO DE INFORMES MENSUALES - TUTORES DE CURSO</h3>
...
function filtrarMes() {
    ...
    window.location.href = "index.php?pagina=reportes_generales/report_informe_mensual_curso.php&mes=" + mes;
}
