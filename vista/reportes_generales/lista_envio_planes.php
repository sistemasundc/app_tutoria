...
if (!isset($_SESSION['S_IDUSUARIO']) || !in_array($_SESSION['S_ROL'], ['SUPERVISION','COORDINADOR GENERAL DE TUTORIA','DIRECCION DE ESCUELA','VICEPRESIDENCIA ACADEMICA'])) {
...
<body>
    ...
    <div class="contenedor">
        ...
        <table>
            <thead><tr><th>Nº</th><th>Docente</th><th>Correo</th><th>Ciclo</th><th>Estado</th></tr></thead>
            <tbody>
        ...
        <table>
            ...
            <tbody>
                <?php if (count($no_enviaron) === 0): ?>
                    <tr><td colspan="5">Todos los docentes han enviado su plan.</td></tr>
                <?php else: ?>
