...
WHERE cl.id_car = ?        -- p.ej. 1
  AND cl.id_semestre = ?   -- p.ej. 33
...
<body>
<h2>
  REPORTE DE ACTIVIDAD DE TUTORES - <?= strtoupper($escuela) ?> - <?= strtoupper($mes_seleccionado) ?> - 2025-2
</h2>
    ...
    <table class="tabla">
      ...
      <tbody>
        <?php if (empty($tutores)): ?>
          <tr><td colspan="5" class="muted">Sin tutores registrados para el semestre seleccionado.</td></tr>
