...
if (!isset($_SESSION['S_IDUSUARIO']) || !in_array($_SESSION['S_ROL'], ['SUPERVISION', 'COORDINADOR GENERAL DE TUTORIA', 'DIRECTOR DE DEPARTAMENTO ACADEMICO', 'VICEPRESIDENCIA ACADEMICA'])) {
