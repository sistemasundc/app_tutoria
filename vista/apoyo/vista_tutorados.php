...
<div class="col-md-8">
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
              <h3 class="box-title">BIENVENIDO AL CONTENIDO DE APOYO</h3>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <button class="btn btn-danger" style="width:100%" onclick="#"><i class="glyphicon glyphicon-plus"></i>Nuevo Registro</button>
                </div>
             </div>
